...
if "%ACTION%"=="6" (
  set /p PALMERI_FLIGHT_DATE=Flight date YYYY-MM-DD:
  set /p PALMERI_JOBXML=Optional JobXML path ^(Enter = campaign default^):
  set "PALMERI_MODE=single"
  set "PALMERI_OVERWRITE=0"
  "%METASHAPE_EXE%" -r "%CD%\scripts\palmeri_pipeline.py"
)
pause
